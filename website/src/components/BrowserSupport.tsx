...
const EdgeIcon = () => (
  <svg viewBox="0 0 48 48" aria-hidden="true">
    ...
    <path
      d="M8 24C8 14 15 8 24 8c6 0 11 3 14 8H24c-5 0-9 4-9 9s4 9 9 9h18a22 22 0 0 1-18 8C14 42 8 33.97 8 24z"
      fill="url(#eg2)"
    />
  </svg>
)
...
const FirefoxIcon = () => (
  <svg viewBox="0 0 48 48" aria-hidden="true">
    ...
    <path
      d="M24 11c-7 0-13 6-13 13 0 5 2.8 9.3 7 11.5-1.5-2-2.5-4.5-2.5-7A9.5 9.5 0 0 1 24 19c3 0 5.7 1.4 7.5 3.5C30 17 27.3 14 24 14c-1 0-2 .2-3 .5A9.5 9.5 0 0 1 33.5 24a9.5 9.5 0 0 1-9.5 9.5 9.5 9.5 0 0 1-7-3C19 34 21.3 37 24 37c7 0 13-6 13-13S31 11 24 11z"
      fill="#ff3750"
    />
  </svg>
)
